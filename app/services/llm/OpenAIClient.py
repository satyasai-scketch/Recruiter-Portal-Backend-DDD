...
class OpenAIClient(LLMChatClient):
    ...
    async def chat_completion(self, messages: List[Dict[str, Any]],model: str = "gpt-4o-mini", temperature: float = 0.7, max_tokens: int = 5000,response_format: Dict[str, Any] = None) -> Dict[str, Any]:
