...
class PersonaWarningGenerator2:
    ...
    async def generate_all_warnings(
        ...
        """
        try:
            prompt = PersonaPrompts2.warning_generation_prompt(persona_data, jd_analysis)
    ...
    async def generate_single_warning(
        ...
        """
        try:
            prompt = PersonaPrompts2.single_entity_warning_prompt(entity_type, entity_data)
